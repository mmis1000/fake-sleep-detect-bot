...
api.on('message', function(message) {
    ...
    if (message.text && message.text.match(/*/^\/ping/*/ RegExp("^\\/ping(@"+ botInfo.username +")?(\\s|$)"))) {
        // echo the text back
    ...
    // if there is the text
    if (message.text && message.text.match(/*/^\/reset_untrusted_sleep/*/ RegExp("^\\/reset_untrusted_sleep(@"+ botInfo.username +")?(\\s|$)"))) {
        untrustedSleep = {};
    ...
    // if there is the text
    if (message.text && message.text.match(/*/^\/status/*/ RegExp("^\\/status(@"+ botInfo.username +")?(\\s|$)"))) {
        // echo the text back
